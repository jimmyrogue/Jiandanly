...
from .model_services import list_model_service_presets
...
async def verify_model_service_model(
    ...
    # Preserve the historical model_service_routes monkeypatch seam.
    from .model_service_routes import _verify_model_service_capability
