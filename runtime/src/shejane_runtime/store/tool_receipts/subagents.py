"""P10 SubAgent receipt projections and lifecycle events."""
...
from ..errors import RunResultConflictError, ToolReceiptStateError
...
class SubagentReceiptStore(SqliteDatabase):
    @staticmethod
    ...
    async def _subagent_invocations_uncommitted(
        ...
        return [SubagentReceiptStore._subagent_invocation_projection(dict(row)) for row in rows]
